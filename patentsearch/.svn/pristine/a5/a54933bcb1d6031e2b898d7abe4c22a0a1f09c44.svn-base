var ExperEnTrancesTips = {
    ...
    CN_PA: "<strong>应用示例</strong><br/>    &nbsp;&nbsp;1、已知完整发明（申请|代理）人姓名，应键入：袁隆平/PA <br/>   &nbsp;&nbsp;2、已知发明（申请|代理）人的一半姓名，应键入：袁隆/PA <br/>   &nbsp;&nbsp;3、已知发明（申请|代理）人姓名包含袁隆平和王光烈，应键入：袁隆平/PA*王光烈/PA<br/>   &nbsp;&nbsp;4、已知发明（申请|代理）人姓名包含袁隆平或王光烈，应键入：袁隆平/PA+王光烈/PA<br/>   &nbsp;&nbsp;5、已知发明（申请|代理）人姓名包含袁隆平，不包含王光烈，应键入：袁隆平/PA-王光烈/PA<br/>   6、已知发明（申请|代理）人姓名包含袁隆平，不包含王光烈和赵旭日，应键入：袁隆平/PA-（王光烈/PA*赵旭日/PA）",
    ...
    EN_PA: " <strong>应用实例</strong> | 1、已知完整申请（发明）人姓名YOUNG-BAE SOHN ，应键入：YOUNG BAE SOHN/PA  | 2、已知发明（申请）人的一半姓名，应键入：tho$/PA | 3、已知发明（申请）人姓名包含thomas和yoshiki，应键入：thomas/PA*yoshiki/PA | 4、已知发明（申请）人姓名包含thomas或yoshiki，应键入：thomas/PA+yoshiki/PA | 5、已知发明（申请）人姓名包含thomas，不包含yoshiki，应键入：thomas/PA - yoshiki/PA | 6、已知发明（申请）人姓名包含thomas，不包含yoshiki和kathrine，应键入：thomas/PA-（yoshiki/PA*kathrine/PA）| 注：1、使用前方一直符号“$”时，可能会获得其他不相干结果；例如：tho$/PA包含thomas及thomason等英文单词。",
...
ExperEnTrancesTips["CN_IN"] = ExperEnTrancesTips["CN_PA"].replace(/\/PA/g, "/IN");
ExperEnTrancesTips["CN_AT"] = ExperEnTrancesTips["CN_PA"].replace(/\/PA/g, "/AT");
...
ExperEnTrancesTips["EN_IN"] = ExperEnTrancesTips["EN_PA"].replace(/\/PA/g, "/IN");
...
var TableEnTrancesTips = {
    ...
    CN_PA: "<strong>应用示例</strong><br/>    &nbsp;&nbsp;1、已知完整的名称，应键入：袁隆平 <br/>   &nbsp;&nbsp;2、已知发明（申请|代理）人的一半姓名，应键入：袁隆 <br/>   &nbsp;&nbsp;3、已知名称包含袁隆平和王光烈，应键入：袁隆平*王光烈<br/>   &nbsp;&nbsp;4、已知名称包含袁隆平或王光烈，应键入：袁隆平+王光烈<br/>   &nbsp;&nbsp;5、已知名称包含袁隆平，不包含王光烈，应键入：袁隆平-王光烈<br/>   6、已知名称包含袁隆平，不包含王光烈和赵旭日，应键入：袁隆平-（王光烈*赵旭日）",
...
TableEnTrancesTips["CN_IN"] = TableEnTrancesTips["CN_PA"];
TableEnTrancesTips["CN_AT"] = TableEnTrancesTips["CN_PA"];
...
TableEnTrancesTips["EN_IN"] = TableEnTrancesTips["EN_PA"];
