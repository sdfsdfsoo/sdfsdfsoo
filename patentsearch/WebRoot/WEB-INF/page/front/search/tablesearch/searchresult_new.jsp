				...
				<div class="result">
				  <div class="result_title">
				      <ul>
				         ...
				         <li><a href="#"><img src="/images/new/show1.png">图文</a></li>
				         <li class="zsfs"><a  href="#"><img src="/images/new/show2.png">列表</a></li>
				         <span>显示21到30,共197816记录</span>
				      </ul>
				  </div>
				  <div class="handle">
				     <ul>
				       <li><img src="/images/new/handle1.png"></li>
				       <li><img src="/images/new/handle2.png"></li>
				       <li><img src="/images/new/handle3.png"></li>
				       <li><img src="/images/new/handle4.png"></li>
				       <li><img src="/images/new/handle5.png"></li>
				     </ul>
				  </div>
				  <div></div>
				  <div class="listzs">
				       ...
				       <ul>
				        ...
				        <li style="width:400px;">一种新型全方位计算机散热风扇(实用新型)</li>
				        <li style="width:150px;">201520777977.4</li>
				        <li style="width:100px;">2015.10.09</li>
				        <li style="width:88px;">授权</li>
				        <li style="width:150px;">G06F 1/20(2006.01)</li>
				     </ul>
				  </div>
				</div>
				</div>
