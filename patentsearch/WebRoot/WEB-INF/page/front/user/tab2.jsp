...
<html>
  ...
  function deletePatent(){
	...
	<body>
		...
		<div id="dlg3" closed="true" class="easyui-dialog" title="请选择要加入的库："
		...
		<div id="_dataGridDiv2" style="margin: 20px 0;">
			...
			<div id="toolbar">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					iconCls="icon-remove" plain="true" onclick="deletePatent()">删除所选专利</a>
					...
					<div id="dlg-buttons" align="left">
						...
						<div id="ExportCFG" style="min-height: 100px;">
							<ul>
								...
								<li>
									<label>
										<input type="checkbox" id="chkAG" value="agent" name="items"
											onchange="changeItem()">
										专利代理机构
									</label>
								</li>
								...
								<li>
									<label>
										<input type="checkbox" id="chkCL" value="claim" name="items"
											onchange="changeItem()">
										主权项
									</label>
								</li>
								...
								<li>
									<label>
										<input type="checkbox" id="chkdz" value="address" name="items"
											onchange="changeItem()">
										地址
									</label>
								</li>
								<li>
									<label>
										<input type="checkbox" id="chkflzt" value="flzt" name="items"
											onchange="changeItem()">
										法律状态
									</label>
								</li>
