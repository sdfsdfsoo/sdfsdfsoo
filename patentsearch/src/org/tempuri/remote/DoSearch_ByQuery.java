 ...
 */
            ...
            /**
            *  DoSearch_ByQuery bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DoSearch_ByQuery
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected org.tempuri.remote.SearchDbType local_SDbType ;
                           ...
                           */
                           public  org.tempuri.remote.SearchDbType get_SDbType(){
                            ...
                            /**
                               ...
                               */
                               public void set_SDbType(org.tempuri.remote.SearchDbType param){
                        ...
                        */
                        ...
                        /**
                        * field for _strSearchQuery
                        */

                        
                                    protected java.lang.String local_strSearchQuery ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean local_strSearchQueryTracker = false ;

                           public boolean is_strSearchQuerySpecified(){
                               return local_strSearchQueryTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String get_strSearchQuery(){
                               return local_strSearchQuery;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param _strSearchQuery
                               */
                               public void set_strSearchQuery(java.lang.String param){
                            local_strSearchQueryTracker = param != null;
                                   
                                            this.local_strSearchQuery=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DoSearch_ByQuery",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DoSearch_ByQuery",
                ...
                if (local_strUIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (local_strSearchQueryTracker){
                                    namespace = "http://tempuri.org/";
                                    writeStartElement(null, namespace, "_strSearchQuery", xmlWriter);
                             

                                          if (local_strSearchQuery==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("_strSearchQuery cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(local_strSearchQuery);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://tempuri.org/",
                                 ...
                                 if (local_strSIDTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://tempuri.org/",
                                        ...
                                        if (local_strSearchQuery != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(local_strSearchQuery));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("_strSearchQuery cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static DoSearch_ByQuery parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DoSearch_ByQuery object =
                new DoSearch_ByQuery();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DoSearch_ByQuery".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DoSearch_ByQuery)org.tempuri.remote.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","_SDbType").equals(reader.getName())){
                                                ...
                                                object.set_SDbType(org.tempuri.remote.SearchDbType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","_strSearchQuery").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"_strSearchQuery" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.set_strSearchQuery(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
