...
import org.tempuri.remote.DoSearch_ByQuery;
import org.tempuri.remote.DoSearch_ByQueryResponse;
import org.tempuri.remote.GeneralDataInfo;
import org.tempuri.remote.GetGeneralData;
import org.tempuri.remote.GetGeneralDataResponse;
import org.tempuri.remote.GetPatentData;
import org.tempuri.remote.GetPatentDataResponse;
import org.tempuri.remote.PatentDataType;
import org.tempuri.remote.PtDataSvcStub;
import org.tempuri.remote.SearchDbType;
...
@Service
public class WebServiceRemoteClientUtil {
			...
			System.out.println("-----------");
						if(getGeneralDataResponse!=null&&getGeneralDataResponse
							...
							for (GeneralDataInfo generalDataInfo : getGeneralDataResponse
									...
									String appno = generalDataInfo.getStrAN().substring(0,
									        generalDataInfo.getStrAN().length() - 2);
									appnoList.add(appno);
...
//		String ss=getPatentDataByAppno("201430023820", 2);
//		System.out.println("------------");
//		System.out.println(ss);
//		GetGeneralDataParameter getGeneralDataParameter=new GetGeneralDataParameter("1", "Cn", "001", 70, 10);
//		DoSearchParameter doSearchParameter  =new DoSearchParameter("1", "DocDB", "001", "F XX (computer/TI)");
//		DoSearchParameter doSearchParameter  =new DoSearchParameter("1", "Cn", "001", "F YY (计算机/TI)");
